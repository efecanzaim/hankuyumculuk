  ...
  const categories = [
    {
      ...
      description: t('gifts.catRingDesc'),
      image: "/images/products/product-1.jpg",
      href: getLocalizedPath('jewelry/rings', locale),
    },
    {
      title: t('gifts.catNecklace'),
      description: t('gifts.catNecklaceDesc'),
      image: "/images/products/product-2.jpg",
      href: getLocalizedPath('jewelry/necklaces', locale),
    },
    {
      title: t('gifts.catBracelet'),
      description: t('gifts.catBraceletDesc'),
      image: "/images/products/product-3.jpg",
      href: getLocalizedPath('jewelry/bracelets', locale),
    },
    {
      title: t('gifts.catEarring'),
      description: t('gifts.catEarringDesc'),
      image: "/images/products/product-4.jpg",
      href: getLocalizedPath('jewelry/earrings', locale),
    },
  ];
