                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p
                        ...
                        style={{ fontFamily: 'var(--font-bw-modelica), sans-serif' }}
                      >
                        {product.subtitle || t('customDesign.title')}
                      </p>
                    </div>
                  </div>
                </Link>
