...
export const routeMap: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    'collection/light-of-my-eyes': '/en/collection/gozumun-nuru',
  ...
  ru: {
    ...
    collection: '/ru/kollektsiya',
    'collection/light-of-my-eyes': '/ru/kollektsiya/gozumun-nuru',
